  ...
  <div class="p-2">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <j-upload-button  type="primary" v-auth="'jxcmanage:t_b_style:importExcel'"  preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'jxcmanage:t_b_style:deleteBatch'">批量操作
...
<script lang="ts" name="jxcmanage-tBStyle" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns, superQuerySchema } from './TBStyle.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './TBStyle.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import TBStyleModal from './components/TBStyleModal.vue'
