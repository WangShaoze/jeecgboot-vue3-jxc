    ...
    <JFormContainer :disabled="disabled">
      <template #detail>
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol" name="TBStyleForm">
          <a-row>
						<a-col :span="24">
							<a-form-item label="款号" v-bind="validateInfos.styleNo" id="TBStyleForm-styleNo" name="styleNo">
						...
						<a-col :span="24">
							<a-form-item label="客户" v-bind="validateInfos.customAccount" id="TBStyleForm-customAccount" name="customAccount">
						...
						<a-col :span="24">
							<a-form-item label="银工费" v-bind="validateInfos.sliverProcessFee" id="TBStyleForm-sliverProcessFee" name="sliverProcessFee">
