...
<script lang="ts" setup>
    ...
    //渲染流程表单数据
    const queryByIdUrl = '/jxcmanage/tBStyleForCK/queryById';
    async function initFormData(){
      if(props.formBpm === true){
        ...
        requestSubTableData(queryTBGoodsForCK, {id: data.id}, tBGoodsForCKTable, ()=>{
          tBGoodsForCKTable.show = true;
        });
        // 隐藏底部时禁用整个表单
