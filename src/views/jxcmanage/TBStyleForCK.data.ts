...
export const formSchema: FormSchema[] = [
  ...
  {
    label: '平均总重',
    field: 'avgTotalWeight',
    component: 'InputNumber',
  },
  {
    label: '经销工费',
    field: 'distributorCost',
    component: 'InputNumber',
  },
  {
    label: '零售工费',
...
export const tBGoodsForCKJVxeColumns: JVxeColumn[] = [
  ...
  {
    title: '参考零售价',
    key: 'retailReferenceSellingPrice',
    type: JVxeTypes.inputNumber,
    width: '200px',
    placeholder: '请输入${title}',
    defaultValue: '',
  ...
  {
    title: '参考一口价',
    key: 'retailFixedReferenceSellingPrice',
    type: JVxeTypes.inputNumber,
    width: '200px',
    placeholder: '请输入${title}',
    defaultValue: '',
