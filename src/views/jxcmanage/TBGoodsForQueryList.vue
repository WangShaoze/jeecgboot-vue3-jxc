<template>
  <div class="p-2">
        ...
        <a-row :gutter="24">
          <a-col :lg="3">
            <a-form-item name="styleCategory">
              ...
              <JInput v-model:value="queryParam.styleCategory" />
            </a-form-item>
          </a-col>
          <a-col :lg="3">
    ...
    <!-- 表单区域 -->
    <TBGoodsForQueryModal ref="registerModal" @success="handleSuccess"></TBGoodsForQueryModal>
  </div>
</template>

<script lang="ts" name="jxcmanage-tBGoodsForQuery" setup>
