...
<!--          </a-button>-->
    ...
    <!-- 表单区域 -->
    <TBStyleForZICModal @register="registerModal" @success="handleSuccess"></TBStyleForZICModal>
    <a-modal
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <a-select v-model:value="searchForm.status" placeholder="请选择状态" style="width: 160px" allow-clear>
            ...
            <a-select-option :value="5">已售</a-select-option>
          </a-select>
        </div>
...
<script lang="ts" name="jxcmanage-tBStyleForZIC" setup>
  import { ref, reactive, computed, unref, provide } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { useModal } from '/@/components/Modal';
  import TBStyleForZICModal from './components/TBStyleForZICModal.vue';
  import { useUserStore } from '/@/store/modules/user';
  import TBGoodsZICList from './TBGoodsZICList.vue';
  import { columns, searchFormSchema, superQuerySchema } from './TBStyleForZIC.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './TBStyleForZIC.api';
